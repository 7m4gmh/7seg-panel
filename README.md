...
- **Development**: Use macOS with emulator mode for development and testing
- **Production**: Deploy on Radxa ROCK 5B or Raspberry Pi 4/5
- **Testing**: See [RPi5 Test Guide](RPI5_TEST_README.md) for Raspberry Pi 5 testing procedures

## 📋 Platform Support

**Primary Platform**: Radxa ROCK 5B (fully tested and optimized)

**Secondary Platforms**:
- Raspberry Pi 4/5 (with I2C enabled, bus numbers may differ)
- macOS (emulator mode only for development)
